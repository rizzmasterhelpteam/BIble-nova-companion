...
import voiceLiveTokenHandler from "./api/voice/live-token";
...
app.post("/api/voice/live-token", voiceLiveTokenHandler);
app.options("/api/voice/live-token", voiceLiveTokenHandler);
