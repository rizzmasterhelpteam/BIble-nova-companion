-- Turn-based Voice keeps one lease for the full reflection.
-- Remove the old Gemini Live renewal-claim dependency from the lease RPCs.
...
drop function if exists private.cleanup_stale_voice_renewal_claims(uuid);
