-- Existing projects may have skipped the earlier canonical Voice migration.
-- Re-apply the exact six-argument contract as a forward migration so the
-- deployed server and the live PostgREST schema cannot drift.
